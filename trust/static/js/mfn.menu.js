		...
		muffingroup_menu: function(options) {
			...
			menu.find("li").hover(function() {
				...
				if (options.animation === "fade") {
					$(this).children(".sub-menu").fadeIn(options.delay);
				} else if (options.animation === "toggle") {
					$(this).children(".sub-menu").stop(true,true).slideDown(options.delay);
				}
			}, function(){
				$(this).removeClass(options.hoverClass);
				if (options.animation === "fade") {
					$(this).children(".sub-menu").fadeOut(options.delay);
				} else if (options.animation === "toggle") {
					$(this).children(".sub-menu").stop(true,true).slideUp(options.delay);
				}
			});
